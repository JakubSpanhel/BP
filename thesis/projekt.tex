...
\projectinfo{
  ...
  %Nazev prace
  title.cs={Detekce automobilů v obraze},  %nazev prace v cestine
  title.en={Detection of vehicles in image}, %nazev prace v anglictine
  %Autor
  author={Jakub Špaňhel},   %jmeno prijmeni autora
